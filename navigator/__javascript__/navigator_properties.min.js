...
a.slice(2))};D(c,"",L(c.org.transcrypt.__base__));A=c.__envir__;D(c,"",L(c.org.transcrypt.__standard__));var da=c.Exception,ea=c.StopIteration,J=c.ValueError,N=c.KeyError,fa=c.AssertionError,P=c.py_TypeError,ha=c.__sort__;c.print=c.__terminal__.print;c.input=c.__terminal__.input;A.executor_name=A.transpiler_name;c.main={__file__:""};c.__except__=null;var y=function(a){a.__kwargtrans__=null;a.constructor=Object;return a};c.__kwargtrans__=y;c.__globals__=function(a){return K(a,z)?a:z(a)};c.__super__=
...
a;if(c==b)return!0;for(d=[].slice.call(c.__bases__);d.length;){c=d.shift();if(c==b)return!0;c.__bases__.length&&(d=[].slice.call(c.__bases__).concat(d))}return!1}catch(ia){return a==b||b==t}};c.issubclass=G;var K=function(a,b){try{return"__class__"in a?G(a.__class__,b):G(H(a),b)}catch(d){return G(H(a),b)}};c.isinstance=K;c.callable=function(a){return a&&"object"==typeof a&&"__call__"in a?!0:"function"===typeof a};var I=function(a){try{return a.__repr__()}catch(ja){try{return a.__str__()}catch(ka){try{if(null==
...
d,c],e):a.__setslice__(b,d,c,e)};(function(){var a=n("TestSystem",[t],{__module__:"__main__",get __init__(){return h(this,function(a){})},get info(){return h(this,function(a){a="Browser CodeName: "+navigator.appCodeName+"<br>\n";a=a+"Browser Name: "+navigator.appName+"<br>\n";a=a+"Version Info: "+navigator.appVersion+"<br>\n";a=a+"Cookies Enabled: "+navigator.cookieEnabled+"<br>\n";a=a+"Language of the browser: "+navigator.language+"<br>\n";a=a+"Is the browser online? "+navigator.onLine+"<br>\n";
a=a+"Platform: "+navigator.platform+"<br>\n";a=a+"Browser's Engine Name: "+navigator.product+"<br>\n";a=a+"User-agent header sent: "+navigator.userAgent+"<br>\n";a=a+"Java Enabled: "+navigator.javaEnabled()+"<br>\n";a=a+"Data tainting enabled: "+navigator.taintEnabled();document.getElementById("msg").innerHTML=a})},get getLocation(){return h(this,function(a){navigator.geolocation?navigator.geolocation.getCurrentPosition(a.showPosition):document.getElementById("loc").innerHTML="Geolocation is not supported by this browser."})},
get showPosition(){return h(this,function(a,b){document.getElementById("loc").innerHTML="Latitude: "+b.coords.latitude+"<br>Longitude: "+b.coords.longitude})}}),b=a();c.TestSystem=a;c.__name__="__main__";c.testSystem=b})();return c}window.navigator_properties=navigator_properties();
