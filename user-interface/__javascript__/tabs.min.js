...
function tabs(){function e(a){return void 0===a||null===a?!1:0<=["boolean","number"].indexOf(typeof a)?a:a.__bool__ instanceof Function?a.__bool__()?a:!1:a.__len__ instanceof Function?0!==a.__len__()?a:!1:a instanceof Function?a:0!==x(a)?a:!1}function g(a){this.iterable=a;this.index=0}function f(a){this.iterable=a;this.index=0}function h(a,b,d){void 0==b&&(b=a,a=0);void 0==d&&(d=1);if(0<d&&a>=b||0>d&&a<=b)return[];for(var c=[];0<d?a<b:a>b;a+=d)c.push(a);return c}function w(a){if(null==a||"object"==
...
u){b=new Uint8Array(x(a));for(var d=0;d<x(a);d++)b[d]=a.charCodeAt(d);return b}if(b==l||b==p)return new Uint8Array(a);throw P;}function u(a){if("number"===typeof a)return a.toString();try{return a.__str__()}catch(b){try{return I(a)}catch(d){return String(a)}}}function Q(a){return this.hasOwnProperty(a)}function R(){var a=[],b;for(b in this)C(b)||a.push(b);return a}function S(){var a=[],b;for(b in this)C(b)||a.push([b,this[b]]);return a}function T(a){delete this[a]}function U(){for(var a in this)delete this[a]}
...
d,c],e):a.__setslice__(b,d,c,e)};(function(){c.__name__="__main__";c.openLang=function(a,b){for(var c=document.getElementsByClassName("tabcontent"),e=0;e<c.length;e++)c[e].style.display="none";c=document.getElementsByClassName("tablinks");for(e=0;e<c.length;e++)c[e].className=c[e].className.py_replace(" active","");document.getElementById(b).style.display="block";a.currentTarget.className+=" active"}})();return c}window.tabs=tabs();
