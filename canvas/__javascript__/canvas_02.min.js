...
function canvas_02(){function e(a){return void 0===a||null===a?!1:0<=["boolean","number"].indexOf(typeof a)?a:a.__bool__ instanceof Function?a.__bool__()?a:!1:a.__len__ instanceof Function?0!==a.__len__()?a:!1:a instanceof Function?a:0!==x(a)?a:!1}function g(a){this.iterable=a;this.index=0}function f(a){this.iterable=a;this.index=0}function k(a,b,d){void 0==b&&(b=a,a=0);void 0==d&&(d=1);if(0<d&&a>=b||0>d&&a<=b)return[];for(var c=[];0<d?a<b:a>b;a+=d)c.push(a);return c}function w(a){if(null==a||"object"==
...
c,e],f):a.__setslice__(b,c,e,f)};(function(){var a=n("Graphics",[t],{__module__:"__main__",get __init__(){return h(this,function(a,b){a.canvas_id=b;a.ctx=document.getElementById(a.canvas_id).getContext("2d");a.img=new Image;a.img.src="https://mdn.mozillademos.org/files/5395/backdrop.png";if("undefined"==a.img.naturalWidth||0==a.img.naturalWidth)a.img.src="backdrop.png";a.img.onload=a.display})},get display(){return h(this,function(a){a.ctx.drawImage(a.img,0,0);a.ctx.beginPath();a.ctx.moveTo(30,96);
a.ctx.lineTo(70,66);a.ctx.lineTo(103,76);a.ctx.lineTo(170,15);a.ctx.stroke()})}}),b=a("graphics");c.Graphics=a;c.__name__="__main__";c.graphic=b})();return c}window.canvas_02=canvas_02();
