"use strict";
// Transcrypt'ed from Python, 2018-03-04 19:10:37
function canvas_05b_tf () {
		...
		'TranscryptFrame', {
			__all__: {
				...
				__init__: function (__all__) {
					...
					var loc = location;
					var win = window;
					var CanvasImage = __class__ ('CanvasImage', [object], {
						__module__: __name__,
						get __init__ () {return __get__ (this, function (self, src, canvas_id, width, height, position) {
							if (typeof src == 'undefined' || (src != null && src .hasOwnProperty ("__kwargtrans__"))) {;
								var src = null;
							};
							if (typeof canvas_id == 'undefined' || (canvas_id != null && canvas_id .hasOwnProperty ("__kwargtrans__"))) {;
								var canvas_id = null;
							};
							...
							self.position = tuple ([self.pos_x, self.pos_y]);
							self.set_canvas (canvas_id);
							self.img = new Image ();
							self.open (src, canvas_id);
							return self;
						});},
						get copy () {return __get__ (this, function (self, canvas_id) {
							if (typeof canvas_id == 'undefined' || (canvas_id != null && canvas_id .hasOwnProperty ("__kwargtrans__"))) {;
								var canvas_id = null;
							};
							var new_image = Image (self.src, canvas_id, self.width, self.height);
							return new_image;
						});},
						get open () {return __get__ (this, function (self, src, canvas_id) {
							if (typeof canvas_id == 'undefined' || (canvas_id != null && canvas_id .hasOwnProperty ("__kwargtrans__"))) {;
								var canvas_id = null;
							};
							self.src = src;
						...
						get _post_loading () {return __get__ (this, function (self) {
							self.width = self.img.naturalWidth;
							self.height = self.img.naturalHeight;
							self.size = tuple ([self.width, self.height]);
							self.show ();
						});},
						get resize () {return __get__ (this, function (self, size, position) {
							if (typeof position == 'undefined' || (position != null && position .hasOwnProperty ("__kwargtrans__"))) {;
								var position = null;
							};
							var __left0__ = size;
						...
						get rotate () {return __get__ (this, function (self, degree) {
							if (self.ctx !== null) {
								self.ctx.clearRect (0, 0, self.canvasWidth, self.canvasHeight);
								...
								var __except0__ = AttributeError ('No context/canvas id exists for showing the image, use set_canvas to define canvas_id for the image.');
								__except0__.__cause__ = null;
								throw __except0__;
							}
						});},
						get set_canvas () {return __get__ (this, function (self, canvas_id) {
						...
						get show () {return __get__ (this, function (self, position, width, height) {
							if (typeof position == 'undefined' || (position != null && position .hasOwnProperty ("__kwargtrans__"))) {;
								var position = null;
							};
							if (typeof width == 'undefined' || (width != null && width .hasOwnProperty ("__kwargtrans__"))) {;
						...
						get thumbnail () {return __get__ (this, function (self, size, position) {
							if (typeof position == 'undefined' || (position != null && position .hasOwnProperty ("__kwargtrans__"))) {;
								var position = null;
							};
							var __left0__ = size;
					...
					'</use>')
					__pragma__ ('<all>')
						__all__.CanvasImage = CanvasImage;
						__all__.S = S;
						__all__.__name__ = __name__;
...
window ['canvas_05b_tf'] = canvas_05b_tf ();
