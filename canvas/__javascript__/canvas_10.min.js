...
function canvas_10(){function e(a){return void 0===a||null===a?!1:0<=["boolean","number"].indexOf(typeof a)?a:a.__bool__ instanceof Function?a.__bool__()?a:!1:a.__len__ instanceof Function?0!==a.__len__()?a:!1:a instanceof Function?a:0!==x(a)?a:!1}function g(a){this.iterable=a;this.index=0}function f(a){this.iterable=a;this.index=0}function k(a,b,d){void 0==b&&(b=a,a=0);void 0==d&&(d=1);if(0<d&&a>=b||0>d&&a<=b)return[];for(var c=[];0<d?a<b:a>b;a+=d)c.push(a);return c}function w(a){if(null==a||"object"==
...
v){b=new Uint8Array(x(a));for(var d=0;d<x(a);d++)b[d]=a.charCodeAt(d);return b}if(b==m||b==p)return new Uint8Array(a);throw P;}function v(a){if("number"===typeof a)return a.toString();try{return a.__str__()}catch(b){try{return I(a)}catch(d){return String(a)}}}function Q(a){return this.hasOwnProperty(a)}function R(){var a=[],b;for(b in this)C(b)||a.push(b);return a}function S(){var a=[],b;for(b in this)C(b)||a.push([b,this[b]]);return a}function T(a){delete this[a]}function U(){for(var a in this)delete this[a]}
...
d,c],e):a.__setslice__(b,d,c,e)};(function(){var a=n("Graphics",[t],{__module__:"__main__",get __init__(){return h(this,function(a,b){a.canvas_id=b;a.ctx=document.getElementById(a.canvas_id).getContext("2d");b=p([31,69,1,-1,8,25,1,1]);a.ax=b[0];a.ay=b[1];a.adx=b[2];a.ady=b[3];a.bx=b[4];a.by=b[5];a.bdx=b[6];a.bdy=b[7];a.ani=setInterval(a.animate,50)})},get animate(){return h(this,function(a){150==a.ax?a.adx=-1:0==a.ax&&(a.adx=1);150==a.ay?a.ady=-1:0==a.ay&&(a.ady=1);a.ax+=a.adx;a.ay+=a.ady;150==a.bx?
a.bdx=-1:0==a.bx&&(a.bdx=1);150==a.by?a.bdy=-1:0==a.by&&(a.bdy=1);a.bx+=a.bdx;a.by+=a.bdy;a.ctx.clearRect(0,0,200,200);a.ctx.rect(0,0,200,200);a.ctx.stroke();a.ctx.fillStyle="rgba(0, 0, 255, 0.5)";a.ctx.fillRect(a.ax,a.ay,50,50);a.ctx.fillStyle="rgba(0, 255, 0, 0.5)";a.ctx.fillRect(a.bx,a.by,50,50)})}}),b=a("graphics");c.Graphics=a;c.__name__="__main__";c.graphic=b})();return c}window.canvas_10=canvas_10();
