"use strict";
// Transcrypt'ed from Python, 2018-02-18 21:29:50
function turtle_tree () {
		...
		'turtle', {
			__all__: {
				...
				__init__: function (__all__) {
					...
					var _defaultElement = document.getElementById ('__turtlegraph__');
					if (!(_defaultElement)) {
					...
					var reset = function () {
						...
						bgcolor ('white');
						var __iterable0__ = _allTurtles;
						for (var __index0__ = 0; __index0__ < len (__iterable0__); __index0__++) {
							var turtle = __iterable0__ [__index0__];
							turtle.reset ();
							turtle.done ();
						}
					};
					var py_clear = function () {
						var __iterable0__ = _allTurtles;
						for (var __index0__ = 0; __index0__ < len (__iterable0__); __index0__++) {
							var turtle = __iterable0__ [__index0__];
							turtle.py_clear ();
...
window ['turtle_tree'] = turtle_tree ();
