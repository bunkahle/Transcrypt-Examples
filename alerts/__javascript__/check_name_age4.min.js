...
function check_name_age4(){function e(a){return void 0===a||null===a?!1:0<=["boolean","number"].indexOf(typeof a)?a:a.__bool__ instanceof Function?a.__bool__()?a:!1:a.__len__ instanceof Function?0!==a.__len__()?a:!1:a instanceof Function?a:0!==x(a)?a:!1}function g(a){this.iterable=a;this.index=0}function f(a){this.iterable=a;this.index=0}function k(a,b,d){void 0==b&&(b=a,a=0);void 0==d&&(d=1);if(0<d&&a>=b||0>d&&a<=b)return[];for(var c=[];0<d?a<b:a>b;a+=d)c.push(a);return c}function w(a){if(null==
a||"object"==typeof a)return a;var b={},d;for(d in obj)a.hasOwnProperty(d)&&(b[d]=a[d]);return b}function r(a){if(null==a||"object"==typeof a)return a;var b={},d;for(d in obj)a.hasOwnProperty(d)&&(b[d]=r(a[d]));return b}function m(a){return a?[].slice.apply(a):[]}function p(a){a=a?[].slice.apply(a):[];a.__class__=p;return a}function q(a){var b=[];if(a)for(var d=0;d<a.length;d++)b.add(a[d]);b.__class__=q;return b}function M(a,b){if(void 0==a)return new Uint8Array(0);b=H(a);if(b==A)return new Uint8Array(a);
if(b==v){b=new Uint8Array(x(a));for(var d=0;d<x(a);d++)b[d]=a.charCodeAt(d);return b}if(b==m||b==p)return new Uint8Array(a);throw P;}function v(a){if("number"===typeof a)return a.toString();try{return a.__str__()}catch(b){try{return I(a)}catch(d){return String(a)}}}function Q(a){return this.hasOwnProperty(a)}function R(){var a=[],b;for(b in this)C(b)||a.push(b);return a}function S(){var a=[],b;for(b in this)C(b)||a.push([b,this[b]]);return a}function T(a){delete this[a]}function U(){for(var a in this)delete this[a]}
...
Object)b=a;else throw J("Invalid type of object for dict creation",Error());l(b,"__class__",{value:z,enumerable:!1,writable:!0});l(b,"__contains__",{value:Q,enumerable:!1});l(b,"py_keys",{value:R,enumerable:!1});l(b,"__iter__",{value:function(){new g(this.py_keys())},enumerable:!1});l(b,Symbol.iterator,{value:function(){new f(this.py_keys())},enumerable:!1});l(b,"py_items",{value:S,enumerable:!1});l(b,"py_del",{value:T,enumerable:!1});l(b,"py_clear",{value:U,enumerable:!1});l(b,"py_get",{value:V,
...
a.slice(2))};D(c,"",L(c.org.transcrypt.__base__));B=c.__envir__;D(c,"",L(c.org.transcrypt.__standard__));var ea=c.Exception,fa=c.StopIteration,J=c.ValueError,N=c.KeyError,ha=c.AssertionError,P=c.py_TypeError,ia=c.__sort__;c.print=c.__terminal__.print;c.input=c.__terminal__.input;B.executor_name=B.transpiler_name;c.main={__file__:""};c.__except__=null;var y=function(a){a.__kwargtrans__=null;a.constructor=Object;return a};c.__kwargtrans__=y;c.__globals__=function(a){return K(a,z)?a:z(a)};c.__super__=
function(a,b){for(var d=0;d<a.__bases__.length;d++){var c=a.__bases__[d];if(b in c)return c[b]}throw new ea("Superclass method not found");};c.property=function(a,b){b||(b=function(){});return{get:function(){return a(this)},set:function(a){b(this,a)},enumerable:!0}};var l=function(a,b,d){a.hasOwnProperty(b)||Object.defineProperty(a,b,d)};c.__setProperty__=l;c.assert=function(a,b){if(!a)throw ha(b,Error());};c.__merge__=function(a,b){var d={},c;for(c in a)d[c]=a[c];for(c in b)d[c]=b[c];return d};c.dir=
...
}return+a};E.__name__="float";E.__bases__=[t];c.float=E;var A=function(a){return E(a)|0};A.__name__="int";A.__bases__=[t];c.int=A;var F=function(a){return!!e(a)};F.__name__="bool";F.__bases__=[A];c.bool=F;var H=function(a){var b=typeof a;if("object"==b)try{return"__class__"in a?a.__class__:t}catch(d){return b}else return"boolean"==b?F:"string"==b?v:"number"==b?0==a%1?A:E:null};c.py_typeof=H;var G=function(a,b){if(b instanceof Array){for(var d=0;d<b.length;d++){var c=b[d];if(G(a,c))return!0}return!1}try{c=
a;if(c==b)return!0;for(d=[].slice.call(c.__bases__);d.length;){c=d.shift();if(c==b)return!0;c.__bases__.length&&(d=[].slice.call(c.__bases__).concat(d))}return!1}catch(da){return a==b||b==t}};c.issubclass=G;var K=function(a,b){try{return"__class__"in a?G(a.__class__,b):G(H(a),b)}catch(d){return G(H(a),b)}};c.isinstance=K;c.callable=function(a){return a&&"object"==typeof a&&"__call__"in a?!0:"function"===typeof a};var I=function(a){try{return a.__repr__()}catch(ja){try{return a.__str__()}catch(ka){try{if(null==
...
d,c],e):a.__setslice__(b,d,c,e)};(function(){var a=n("TestSystem",[t],{__module__:"__main__",get __init__(){return h(this,function(a){a.askname="What is your name, dear?";a.askage="And what is your age?"})},get py_isNaN(){return h(this,function(a,b){try{return A(b),!1}catch(da){return!0}})},get questions(){return h(this,function(a){confirm("Are you ready?");a.ask_name();a.ask_age();a.py_isNaN(a.age)?a.message="You are to silly to enter your age.":21>A(a.age)?a.message="Sorry, "+a.py_name+", you're too young to enter with "+
a.age:a.message="Welcome, "+a.py_name;alert(a.message);document.getElementById("test").innerHTML=a.message})},get ask_name(){return h(this,function(a){a.py_name=prompt(a.askname,"")})},get ask_age(){return h(this,function(a){a.age=prompt("Hello, "+a.py_name+". "+a.askage,"")})}}),b=a();c.TestSystem=a;c.__name__="__main__";c.testSystem=b})();return c}window.check_name_age4=check_name_age4();
