...
function check_name_age3(){function e(a){return void 0===a||null===a?!1:0<=["boolean","number"].indexOf(typeof a)?a:a.__bool__ instanceof Function?a.__bool__()?a:!1:a.__len__ instanceof Function?0!==a.__len__()?a:!1:a instanceof Function?a:0!==x(a)?a:!1}function g(a){this.iterable=a;this.index=0}function f(a){this.iterable=a;this.index=0}function k(a,b,d){void 0==b&&(b=a,a=0);void 0==d&&(d=1);if(0<d&&a>=b||0>d&&a<=b)return[];for(var c=[];0<d?a<b:a>b;a+=d)c.push(a);return c}function w(a){if(null==
...
a.age:a.message="Welcome, "+a.py_name;alert(a.message)})},get ask_name(){return h(this,function(a){a.py_name=prompt(a.askname,"")})},get ask_age(){return h(this,function(a){a.age=prompt("Hello, "+a.py_name+". "+a.askage,"")})}}),b=a();c.TestSystem=a;c.__name__="__main__";c.testSystem=b})();return c}window.check_name_age3=check_name_age3();
