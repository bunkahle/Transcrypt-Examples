...
function check_name_age2(){function e(a){return void 0===a||null===a?!1:0<=["boolean","number"].indexOf(typeof a)?a:a.__bool__ instanceof Function?a.__bool__()?a:!1:a.__len__ instanceof Function?0!==a.__len__()?a:!1:a instanceof Function?a:0!==x(a)?a:!1}function g(a){this.iterable=a;this.index=0}function f(a){this.iterable=a;this.index=0}function k(a,b,d){void 0==b&&(b=a,a=0);void 0==d&&(d=1);if(0<d&&a>=b||0>d&&a<=b)return[];for(var c=[];0<d?a<b:a>b;a+=d)c.push(a);return c}function w(a){if(null==
...
t;for(t in e)switch(t){case "self":a=e[t];break;case "sep":b=e[t];break;case "end":d=e[t]}}var f=p([].slice.apply(arguments).slice(1,c+1))}else f=p();a.buffer="{}{}{}".format(a.buffer,b.join(function(){for(var a=[],b=f,d=0;d<x(b);d++)a.append(v(b[d]));return a}()),d).__getslice__(-4096,null,1);a.element?(a.element.innerHTML=a.buffer.py_replace("\n","<br>").py_replace(" ","&nbsp"),a.element.scrollTop=a.element.scrollHeight):console.log(b.join(function(){for(var a=[],b=f,d=0;d<x(b);d++)a.append(v(b[d]));
...
a.slice(2))};D(c,"",L(c.org.transcrypt.__base__));B=c.__envir__;D(c,"",L(c.org.transcrypt.__standard__));var da=c.Exception,ea=c.StopIteration,J=c.ValueError,N=c.KeyError,fa=c.AssertionError,P=c.py_TypeError,ha=c.__sort__;c.print=c.__terminal__.print;c.input=c.__terminal__.input;B.executor_name=B.transpiler_name;c.main={__file__:""};c.__except__=null;var y=function(a){a.__kwargtrans__=null;a.constructor=Object;return a};c.__kwargtrans__=y;c.__globals__=function(a){return K(a,z)?a:z(a)};c.__super__=
...
}return+a};E.__name__="float";E.__bases__=[u];c.float=E;var A=function(a){return E(a)|0};A.__name__="int";A.__bases__=[u];c.int=A;var F=function(a){return!!e(a)};F.__name__="bool";F.__bases__=[A];c.bool=F;var H=function(a){var b=typeof a;if("object"==b)try{return"__class__"in a?a.__class__:u}catch(d){return b}else return"boolean"==b?F:"string"==b?v:"number"==b?0==a%1?A:E:null};c.py_typeof=H;var G=function(a,b){if(b instanceof Array){for(var d=0;d<b.length;d++){var c=b[d];if(G(a,c))return!0}return!1}try{c=
...
[this].concat([].slice.apply(arguments)))};Array.prototype.__add__=function(a){return m(this.concat(a))};Array.prototype.__mul__=function(a){for(var b=this,d=1;d<a;d++)b=b.concat(this);return b};Array.prototype.__rmul__=Array.prototype.__mul__;c.tuple=p;p.__name__="tuple";p.__bases__=[u];c.set=q;q.__name__="set";q.__bases__=[u];Array.prototype.__bindexOf__=function(a){a+="";for(var b=0,d=this.length-1;b<=d;){var c=(b+d)/2|0,e=this[c]+"";if(e<a)b=c+1;else if(e>a)d=c-1;else return c}return-1};Array.prototype.add=
...
c,e],f):a.__setslice__(b,c,e,f)};(function(){var a=n("TestSystem",[u],{__module__:"__main__",get __init__(){return h(this,function(a){a.askname="What is your name, dear?";a.askage="And what is your age?"})},get questions(){return h(this,function(a){confirm("Are you ready?");a.ask_name();a.ask_age();try{21>A(a.age)?a.message="Sorry, "+a.py_name+", you're too young to enter with "+a.age:a.message="Welcome, "+a.py_name}catch(t){a.message="You are to silly to enter your age."}alert(a.message)})},get ask_name(){return h(this,
function(a){a.py_name=prompt(a.askname,"")})},get ask_age(){return h(this,function(a){a.age=prompt("Hello, "+a.py_name+". "+a.askage,"")})}}),b=a();c.TestSystem=a;c.__name__="__main__";c.testSystem=b})();return c}window.check_name_age2=check_name_age2();
