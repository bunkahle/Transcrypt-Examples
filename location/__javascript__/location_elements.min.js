...
$jscomp.polyfill=function(e,g,f,h){if(g){f=$jscomp.global;e=e.split(".");for(h=0;h<e.length-1;h++){var w=e[h];w in f||(f[w]={});f=f[w]}e=e[e.length-1];h=f[e];g=g(h);g!=h&&null!=g&&$jscomp.defineProperty(f,e,{configurable:!0,writable:!0,value:g})}};
$jscomp.polyfill("String.prototype.startsWith",function(e){return e?e:function(e,f){var g=$jscomp.checkStringArgs(this,e,"startsWith");e+="";var w=g.length,t=e.length;f=Math.max(0,Math.min(f|0,g.length));for(var l=0;l<t&&f<w;)if(g[f++]!=e[l++])return!1;return l>=t}},"es6","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};$jscomp.symbolCounter_=0;
...
$jscomp.iteratorFromArray=function(e,g){$jscomp.initSymbolIterator();e instanceof String&&(e+="");var f=0,h={next:function(){if(f<e.length){var w=f++;return{value:g(w,e[w]),done:!1}}h.next=function(){return{done:!0,value:void 0}};return h.next()}};h[Symbol.iterator]=function(){return h};return h};$jscomp.polyfill("Array.prototype.keys",function(e){return e?e:function(){return $jscomp.iteratorFromArray(this,function(e){return e})}},"es6","es3");
function location_elements(){function e(a){return void 0===a||null===a?!1:0<=["boolean","number"].indexOf(typeof a)?a:a.__bool__ instanceof Function?a.__bool__()?a:!1:a.__len__ instanceof Function?0!==a.__len__()?a:!1:a instanceof Function?a:0!==x(a)?a:!1}function g(a){this.iterable=a;this.index=0}function f(a){this.iterable=a;this.index=0}function h(a,b,d){void 0==b&&(b=a,a=0);void 0==d&&(d=1);if(0<d&&a>=b||0>d&&a<=b)return[];for(var c=[];0<d?a<b:a>b;a+=d)c.push(a);return c}function w(a){if(null==
a||"object"==typeof a)return a;var b={},d;for(d in obj)a.hasOwnProperty(d)&&(b[d]=a[d]);return b}function t(a){if(null==a||"object"==typeof a)return a;var b={},d;for(d in obj)a.hasOwnProperty(d)&&(b[d]=t(a[d]));return b}function l(a){return a?[].slice.apply(a):[]}function q(a){a=a?[].slice.apply(a):[];a.__class__=q;return a}function r(a){var b=[];if(a)for(var d=0;d<a.length;d++)b.add(a[d]);b.__class__=r;return b}function M(a,b){if(void 0==a)return new Uint8Array(0);b=H(a);if(b==B)return new Uint8Array(a);
if(b==m){b=new Uint8Array(x(a));for(var d=0;d<x(a);d++)b[d]=a.charCodeAt(d);return b}if(b==l||b==q)return new Uint8Array(a);throw P;}function m(a){if("number"===typeof a)return a.toString();try{return a.__str__()}catch(b){try{return I(a)}catch(d){return String(a)}}}function Q(a){return this.hasOwnProperty(a)}function R(){var a=[],b;for(b in this)C(b)||a.push(b);return a}function S(){var a=[],b;for(b in this)C(b)||a.push([b,this[b]]);return a}function T(a){delete this[a]}function U(){for(var a in this)delete this[a]}
...
d[f]};c.__nest__=D;var L=function(a){a.__inited__||(a.__all__.__init__(a.__all__),a.__inited__=!0);return a.__all__};c.__init__=L;var n=function(a,b,d){return a&&(a.hasOwnProperty("__class__")||"string"==typeof a||a instanceof String)?(d&&Object.defineProperty(a,d,{value:function(){var d=[].slice.apply(arguments);return b.apply(null,[a].concat(d))},writable:!0,enumerable:!0,configurable:!0}),function(){var d=[].slice.apply(arguments);return b.apply(null,[a].concat(d))}):b};c.__get__=n;c.__getcm__=
...
h,e)}u.__metaclass__=a;u.__name__=b.startsWith("py_")?b.slice(3):b;u.__bases__=d;for(h in c)e=Object.getOwnPropertyDescriptor(c,h),Object.defineProperty(u,h,e);return u}};A.__metaclass__=A;c.py_metatype=A;var v={__init__:function(a){},__metaclass__:A,__name__:"object",__bases__:[],__new__:function(a){var b=Object.create(this,{__class__:{value:this,enumerable:!0}});this.__init__.apply(null,[b].concat(a));return b}};c.object=v;var p=function(a,b,d,c){void 0===c&&(c=b[0].__metaclass__);return c.__new__(c,
a,b,d)};c.__class__=p;c.__pragma__=function(){};D(c,"org.transcrypt.__base__",{__all__:{__inited__:!1,__init__:function(a){var b=p("__Envir__",[v],{__module__:"org.transcrypt.__base__",get __init__(){return n(this,function(a){a.interpreter_name="python";a.transpiler_name="transcrypt";a.transpiler_version="3.6.94";a.target_subdir="__javascript__"})}}),d=b();a.__Envir__=b;a.__envir__=d;a.__name__="org.transcrypt.__base__"}}});D(c,"org.transcrypt.__standard__",{__all__:{__inited__:!1,__init__:function(a){var b=
p("Exception",[v],{__module__:"org.transcrypt.__standard__",get __init__(){return n(this,function(a){var b=z();if(arguments.length){var d=arguments.length-1;if(arguments[d]&&arguments[d].hasOwnProperty("__kwargtrans__")){var c=arguments[d--],e;for(e in c)switch(e){case "self":a=c[e];break;default:b[e]=c[e]}delete b.__kwargtrans__}d=q([].slice.apply(arguments).slice(1,d+1))}else d=q();a.__args__=d;try{a.stack=b.error.stack}catch(na){a.stack="No stack trace available"}})},get __repr__(){return n(this,
function(a){return x(a.__args__)?"{}{}".format(a.__class__.__name__,I(q(a.__args__))):"{}()".format(a.__class__.__name__)})},get __str__(){return n(this,function(a){return 1<x(a.__args__)?m(q(a.__args__)):x(a.__args__)?m(a.__args__[0]):""})}}),d=p("IterableError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return n(this,function(a,d){b.__init__(a,"Can't iterate over non-iterable",y({error:d}))})}}),c=p("StopIteration",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return n(this,
function(a,d){b.__init__(a,"Iterator exhausted",y({error:d}))})}}),e=p("ValueError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return n(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),f=p("KeyError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return n(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),g=p("AssertionError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return n(this,function(a,d,c){d?b.__init__(a,d,y({error:c})):b.__init__(a,
y({error:c}))})}}),h=p("NotImplementedError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return n(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),k=p("IndexError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return n(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),l=p("AttributeError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return n(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),t=p("py_TypeError",[b],{__module__:"org.transcrypt.__standard__",
get __init__(){return n(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),r=p("Warning",[b],{__module__:"org.transcrypt.__standard__"}),A=p("UserWarning",[r],{__module__:"org.transcrypt.__standard__"}),B=p("DeprecationWarning",[r],{__module__:"org.transcrypt.__standard__"}),C=p("RuntimeWarning",[r],{__module__:"org.transcrypt.__standard__"}),D=function(a,b,d){if("undefined"==typeof b||null!=b&&b.hasOwnProperty("__kwargtrans__"))b=null;if("undefined"==typeof d||null!=d&&d.hasOwnProperty("__kwargtrans__"))d=
!1;if(arguments.length){var c=arguments.length-1;if(arguments[c]&&arguments[c].hasOwnProperty("__kwargtrans__")){c=arguments[c--];for(var e in c)switch(e){case "iterable":a=c[e];break;case "key":b=c[e];break;case "reverse":d=c[e]}}}b?a.sort(function(a,d){if(arguments.length){var c=arguments.length-1;if(arguments[c]&&arguments[c].hasOwnProperty("__kwargtrans__")){c=arguments[c--];for(var e in c)switch(e){case "a":a=c[e];break;case "b":d=c[e]}}}return b(a)>b(d)?1:-1}):a.sort();d&&a.reverse()},E=p("__Terminal__",
...
u;for(u in e)switch(u){case "self":a=e[u];break;case "sep":b=e[u];break;case "end":d=e[u]}}var f=q([].slice.apply(arguments).slice(1,c+1))}else f=q();a.buffer="{}{}{}".format(a.buffer,b.join(function(){for(var a=[],b=f,d=0;d<x(b);d++)a.append(m(b[d]));return a}()),d).__getslice__(-4096,null,1);a.element?(a.element.innerHTML=a.buffer.py_replace("\n","<br>").py_replace(" ","&nbsp"),a.element.scrollTop=a.element.scrollHeight):console.log(b.join(function(){for(var a=[],b=f,d=0;d<x(b);d++)a.append(m(b[d]));
return a}()))})},get input(){return n(this,function(a,b){if(arguments.length){var d=arguments.length-1;if(arguments[d]&&arguments[d].hasOwnProperty("__kwargtrans__")){d=arguments[d--];for(var c in d)switch(c){case "self":a=d[c];break;case "question":b=d[c]}}}a.print("{}".format(b),y({end:""}));c=window.prompt("\n".join(a.buffer.py_split("\n").__getslice__(-16,null,1)));a.print(c);return c})}}),G=E();a.AssertionError=g;a.AttributeError=l;a.DeprecationWarning=B;a.Exception=b;a.IndexError=k;a.IterableError=
d;a.KeyError=f;a.NotImplementedError=h;a.RuntimeWarning=C;a.StopIteration=c;a.py_TypeError=t;a.UserWarning=A;a.ValueError=e;a.Warning=r;a.__Terminal__=E;a.__name__="org.transcrypt.__standard__";a.__sort__=D;a.__terminal__=G;a.filter=function(a,b){null==a&&(a=F);for(var d=[],c=0;c<x(b);c++){var e=b[c];a(e)&&d.append(e)}return d};a.map=function(a,b){for(var d=[],c=0;c<x(b);c++)d.append(a(b[c]));return d};a.sorted=function(a,b,d){if("undefined"==typeof b||null!=b&&b.hasOwnProperty("__kwargtrans__"))b=
...
[this].concat([].slice.apply(arguments)))};Array.prototype.__add__=function(a){return l(this.concat(a))};Array.prototype.__mul__=function(a){for(var b=this,d=1;d<a;d++)b=b.concat(this);return b};Array.prototype.__rmul__=Array.prototype.__mul__;c.tuple=q;q.__name__="tuple";q.__bases__=[v];c.set=r;r.__name__="set";r.__bases__=[v];Array.prototype.__bindexOf__=function(a){a+="";for(var b=0,d=this.length-1;b<=d;){var c=(b+d)/2|0,e=this[c]+"";if(e<a)b=c+1;else if(e>a)d=c-1;else return c}return-1};Array.prototype.add=
...
function(a,b){return"object"==typeof a&&"__getitem__"in a?a.__getitem__(b):("string"==typeof a||a instanceof Array)&&0>b?a[a.length+b]:a[b]};c.__setitem__=function(a,b,d){"object"==typeof a&&"__setitem__"in a?a.__setitem__(b,d):("string"==typeof a||a instanceof Array)&&0>b?a[a.length+b]=d:a[b]=d};c.__getslice__=function(a,b,d,c){return"object"==typeof a&&"__getitem__"in a?a.__getitem__([b,d,c]):a.__getslice__(b,d,c)};c.__setslice__=function(a,b,c,e,f){"object"==typeof a&&"__setitem__"in a?a.__setitem__([b,
c,e],f):a.__setslice__(b,c,e,f)};(function(){var a=function(){for(var a="",c=0;100>c;c++)a=50==c?a+('<a name="para'+m(c)+'"></a><p id="para'+m(c)+'">Paragraph '+m(c)+" - Now please scroll back to the beginning and press show location elements again - look for the hash</p>"):a+('<a name="para'+m(c)+'"></a><p id="para'+m(c)+'">Paragraph '+m(c)+"</p>");document.getElementById("hashtext").innerHTML=a;console.log(a)};c.__name__="__main__";c.create_query=function(){location.search="?testname=transcrypt&lang=python"};
c.goto_hash=function(a){console.log(location.href+"#"+a);location.assign(location.href+"#"+a)};c.init=function(){a()};c.insert_hash=a;c.show=function(){var a="These are the location elements:<br>"+("Sets or returns the anchor part (#) of a URL that begins with the # character as <b>location.hash</b>: "+location.hash+"<br>");a+="Represents the hostname and port number of the URL <b>location.host</b>: "+location.host+"<br>";a+="Represents the hostname part of the URL as <b>location.hostname</b>: "+
location.hostname+"<br>";a+="Represents the complete URL as <b>location.href</b>: "+location.href+"<br>";a+="Returns the protocol, hostname and port number of a URL as <b>location.origin</b>: "+location.origin+"<br>";a+="Represents the pathname part of the URL as <b>location.pathname</b>: "+location.pathname+"<br>";a+="Represents the port part (e.g. :8080) of the URL* as <b>location.port</b>: "+location.port+"<br>";a+="Represents the protocol part of the URL as <b>location.protocol</b>: "+location.protocol+
"<br>";a+="The search part of the URL, including the ? is <b>location.search</b>: "+location.search;a+="<p><b>* Note: </b>If the port number is default (80 for http and 443 for https), most browsers will display 0 or nothing.</p>";document.getElementById("locs").innerHTML=a}})();return c}window.location_elements=location_elements();
