...
$jscomp.polyfill("String.prototype.startsWith",function(e){return e?e:function(e,f){var g=$jscomp.checkStringArgs(this,e,"startsWith");e+="";var w=g.length,r=e.length;f=Math.max(0,Math.min(f|0,g.length));for(var l=0;l<r&&f<w;)if(g[f++]!=e[l++])return!1;return l>=r}},"es6","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};$jscomp.symbolCounter_=0;
...
if(b==u){b=new Uint8Array(x(a));for(var d=0;d<x(a);d++)b[d]=a.charCodeAt(d);return b}if(b==l||b==p)return new Uint8Array(a);throw Q;}function u(a){if("number"===typeof a)return a.toString();try{return a.__str__()}catch(b){try{return I(a)}catch(d){return String(a)}}}function R(a){return this.hasOwnProperty(a)}function S(){var a=[],b;for(b in this)C(b)||a.push(b);return a}function T(){var a=[],b;for(b in this)C(b)||a.push([b,this[b]]);return a}function U(a){delete this[a]}function V(){for(var a in this)delete this[a]}
...
Object)b=a;else throw J("Invalid type of object for dict creation",Error());k(b,"__class__",{value:z,enumerable:!1,writable:!0});k(b,"__contains__",{value:R,enumerable:!1});k(b,"py_keys",{value:S,enumerable:!1});k(b,"__iter__",{value:function(){new g(this.py_keys())},enumerable:!1});k(b,Symbol.iterator,{value:function(){new f(this.py_keys())},enumerable:!1});k(b,"py_items",{value:T,enumerable:!1});k(b,"py_del",{value:U,enumerable:!1});k(b,"py_clear",{value:V,enumerable:!1});k(b,"py_get",{value:W,
enumerable:!1});k(b,"py_setdefault",{value:X,enumerable:!1});k(b,"py_pop",{value:Y,enumerable:!1});k(b,"py_popitem",{value:Z,enumerable:!1});k(b,"py_update",{value:aa,enumerable:!1});k(b,"py_values",{value:ba,enumerable:!1});k(b,"__getitem__",{value:ca,enumerable:!1});k(b,"__setitem__",{value:da,enumerable:!1});return b}var c={},D=function(a,b,d){if(""!=b){b=b.split(".");for(var c=b.length,e=0;e<b.length;e++){if(!a.hasOwnProperty(b[e])){c=e;break}a=a[b[e]]}for(e=c;e<b.length;e++)a[b[e]]={},a=a[b[e]]}for(var f in d)a[f]=
...
a,b,d)};c.__class__=n;c.__pragma__=function(){};D(c,"org.transcrypt.__base__",{__all__:{__inited__:!1,__init__:function(a){var b=n("__Envir__",[v],{__module__:"org.transcrypt.__base__",get __init__(){return m(this,function(a){a.interpreter_name="python";a.transpiler_name="transcrypt";a.transpiler_version="3.6.94";a.target_subdir="__javascript__"})}}),d=b();a.__Envir__=b;a.__envir__=d;a.__name__="org.transcrypt.__base__"}}});D(c,"org.transcrypt.__standard__",{__all__:{__inited__:!1,__init__:function(a){var b=
n("Exception",[v],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,function(a){var b=z();if(arguments.length){var d=arguments.length-1;if(arguments[d]&&arguments[d].hasOwnProperty("__kwargtrans__")){var c=arguments[d--],e;for(e in c)switch(e){case "self":a=c[e];break;default:b[e]=c[e]}delete b.__kwargtrans__}d=p([].slice.apply(arguments).slice(1,d+1))}else d=p();a.__args__=d;try{a.stack=b.error.stack}catch(oa){a.stack="No stack trace available"}})},get __repr__(){return m(this,
function(a){return x(a.__args__)?"{}{}".format(a.__class__.__name__,I(p(a.__args__))):"{}()".format(a.__class__.__name__)})},get __str__(){return m(this,function(a){return 1<x(a.__args__)?u(p(a.__args__)):x(a.__args__)?u(a.__args__[0]):""})}}),d=n("IterableError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,function(a,d){b.__init__(a,"Can't iterate over non-iterable",y({error:d}))})}}),c=n("StopIteration",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,
function(a,d){b.__init__(a,"Iterator exhausted",y({error:d}))})}}),e=n("ValueError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),f=n("KeyError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),g=n("AssertionError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,function(a,d,c){d?b.__init__(a,d,y({error:c})):b.__init__(a,
y({error:c}))})}}),h=n("NotImplementedError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),k=n("IndexError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),l=n("AttributeError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),r=n("py_TypeError",[b],{__module__:"org.transcrypt.__standard__",
get __init__(){return m(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),q=n("Warning",[b],{__module__:"org.transcrypt.__standard__"}),A=n("UserWarning",[q],{__module__:"org.transcrypt.__standard__"}),B=n("DeprecationWarning",[q],{__module__:"org.transcrypt.__standard__"}),C=n("RuntimeWarning",[q],{__module__:"org.transcrypt.__standard__"}),D=function(a,b,d){if("undefined"==typeof b||null!=b&&b.hasOwnProperty("__kwargtrans__"))b=null;if("undefined"==typeof d||null!=d&&d.hasOwnProperty("__kwargtrans__"))d=
...
[v],{__module__:"org.transcrypt.__standard__",get __init__(){return m(this,function(a){a.buffer="";try{a.element=document.getElementById("__terminal__")}catch(na){a.element=null}a.element&&(a.element.style.overflowX="auto",a.element.style.boxSizing="border-box",a.element.style.padding="5px",a.element.innerHTML="_")})},get print(){return m(this,function(a){var b=" ";var d="\n";if(arguments.length){var c=arguments.length-1;if(arguments[c]&&arguments[c].hasOwnProperty("__kwargtrans__")){var e=arguments[c--],
t;for(t in e)switch(t){case "self":a=e[t];break;case "sep":b=e[t];break;case "end":d=e[t]}}var f=p([].slice.apply(arguments).slice(1,c+1))}else f=p();a.buffer="{}{}{}".format(a.buffer,b.join(function(){for(var a=[],b=f,d=0;d<x(b);d++)a.append(u(b[d]));return a}()),d).__getslice__(-4096,null,1);a.element?(a.element.innerHTML=a.buffer.py_replace("\n","<br>").py_replace(" ","&nbsp"),a.element.scrollTop=a.element.scrollHeight):console.log(b.join(function(){for(var a=[],b=f,d=0;d<x(b);d++)a.append(u(b[d]));
return a}()))})},get input(){return m(this,function(a,b){if(arguments.length){var d=arguments.length-1;if(arguments[d]&&arguments[d].hasOwnProperty("__kwargtrans__")){d=arguments[d--];for(var c in d)switch(c){case "self":a=d[c];break;case "question":b=d[c]}}}a.print("{}".format(b),y({end:""}));c=window.prompt("\n".join(a.buffer.py_split("\n").__getslice__(-16,null,1)));a.print(c);return c})}}),G=E();a.AssertionError=g;a.AttributeError=l;a.DeprecationWarning=B;a.Exception=b;a.IndexError=k;a.IterableError=
...
a.slice(2))};D(c,"",L(c.org.transcrypt.__base__));A=c.__envir__;D(c,"",L(c.org.transcrypt.__standard__));var ea=c.Exception,fa=c.StopIteration,J=c.ValueError,N=c.KeyError,ha=c.AssertionError,Q=c.py_TypeError,ia=c.__sort__;c.print=c.__terminal__.print;c.input=c.__terminal__.input;A.executor_name=A.transpiler_name;c.main={__file__:""};c.__except__=null;var y=function(a){a.__kwargtrans__=null;a.constructor=Object;return a};c.__kwargtrans__=y;c.__globals__=function(a){return K(a,z)?a:z(a)};c.__super__=
function(a,b){for(var d=0;d<a.__bases__.length;d++){var c=a.__bases__[d];if(b in c)return c[b]}throw new ea("Superclass method not found");};c.property=function(a,b){b||(b=function(){});return{get:function(){return a(this)},set:function(a){b(this,a)},enumerable:!0}};var k=function(a,b,d){a.hasOwnProperty(b)||Object.defineProperty(a,b,d)};c.__setProperty__=k;c.assert=function(a,b){if(!a)throw ha(b,Error());};c.__merge__=function(a,b){var d={},c;for(c in a)d[c]=a[c];for(c in b)d[c]=b[c];return d};c.dir=
function(a){var b=[],d;for(d in a)b.push(d.startsWith("py_")?d.slice(3):d);b.sort();return b};c.setattr=function(a,b,d){a[b]=d};c.getattr=function(a,b){return b in a?a[b]:a["py_"+b]};c.hasattr=function(a,b){try{return b in a||"py_"+b in a}catch(d){return!1}};c.delattr=function(a,b){b in a?delete a[b]:delete a["py_"+b]};var O=function(a,b){return void 0===b||null===b?!1:b.__contains__ instanceof Function?b.__contains__(a):b.indexOf?-1<b.indexOf(a):b.hasOwnProperty(a)};c.__in__=O;var C=function(a){return a.startswith("__")&&
...
a;if(c==b)return!0;for(d=[].slice.call(c.__bases__);d.length;){c=d.shift();if(c==b)return!0;c.__bases__.length&&(d=[].slice.call(c.__bases__).concat(d))}return!1}catch(ja){return a==b||b==v}};c.issubclass=G;var K=function(a,b){try{return"__class__"in a?G(a.__class__,b):G(H(a),b)}catch(d){return G(H(a),b)}};c.isinstance=K;c.callable=function(a){return a&&"object"==typeof a&&"__call__"in a?!0:"function"===typeof a};var I=function(a){try{return a.__repr__()}catch(ka){try{return a.__str__()}catch(la){try{if(null==
...
[this].concat([].slice.apply(arguments)))};Array.prototype.__add__=function(a){return l(this.concat(a))};Array.prototype.__mul__=function(a){for(var b=this,c=1;c<a;c++)b=b.concat(this);return b};Array.prototype.__rmul__=Array.prototype.__mul__;c.tuple=p;p.__name__="tuple";p.__bases__=[v];c.set=q;q.__name__="set";q.__bases__=[v];Array.prototype.__bindexOf__=function(a){a+="";for(var b=0,c=this.length-1;b<=c;){var e=(b+c)/2|0,f=this[e]+"";if(f<a)b=e+1;else if(f>a)c=e-1;else return e}return-1};Array.prototype.add=
...
c,e],f):a.__setslice__(b,c,e,f)};(function(){var a=function(a){location.assign(a);console.log("a new document was loaded")};c.__name__="__main__";c.assign_page=a;c.reload_page=function(a){if("undefined"==typeof a||null!=a&&a.hasOwnProperty("__kwargtrans__"))a=!1;console.log("document is going to be reloaded");location.reload(a);console.log("document was reloaded")};c.rep_page=function(a){location.replace(a);console.log("document was replaced - should not be in the history anymore")};c.replace_url=
function(){var b=document.getElementById("input_location").value;O("http",b.__getslice__(0,4,1))||(b="http://"+b);a(b)}})();return c}window.location_change=location_change();
