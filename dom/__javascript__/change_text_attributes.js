"use strict";
// Transcrypt'ed from Python, 2018-02-04 23:48:21
function change_text_attributes () {
    ...
    __all__.__setslice__ = __setslice__;	(function () {
		...
		var TestSystem = __class__ ('TestSystem', [object], {
			...
			get change_attr () {return __get__ (this, function (self) {
				document.querySelector ('test').innerText = 'Test String:' + document.querySelector ('output').innerHTML;
				if (__in__ ('STRONG'.lower (), document.querySelector ('output').innerHTML.lower ())) {
...
window ['change_text_attributes'] = change_text_attributes ();
