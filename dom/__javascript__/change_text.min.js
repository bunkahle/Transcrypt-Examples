...
function change_text(){function e(a){return void 0===a||null===a?!1:0<=["boolean","number"].indexOf(typeof a)?a:a.__bool__ instanceof Function?a.__bool__()?a:!1:a.__len__ instanceof Function?0!==a.__len__()?a:!1:a instanceof Function?a:0!==x(a)?a:!1}function g(a){this.iterable=a;this.index=0}function f(a){this.iterable=a;this.index=0}function k(a,b,d){void 0==b&&(b=a,a=0);void 0==d&&(d=1);if(0<d&&a>=b||0>d&&a<=b)return[];for(var c=[];0<d?a<b:a>b;a+=d)c.push(a);return c}function w(a){if(null==a||"object"==
...
d,c],e):a.__setslice__(b,d,c,e)};(function(){var a=n("TestSystem",[t],{__module__:"__main__",get __init__(){return h(this,function(a){a.text="Hello, DOM!";a.text2="Hello, User!"})},get insert(){return h(this,function(a){document.querySelector("output").innerText=a.text})},get change(){return h(this,function(a){document.querySelector("output").innerText==a.text?document.querySelector("output").innerText=a.text2:document.querySelector("output").innerText=a.text})}}),b=a();c.TestSystem=a;c.__name__=
"__main__";c.testSystem=b})();return c}window.change_text=change_text();
