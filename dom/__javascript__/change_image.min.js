...
function change_image(){function e(a){return void 0===a||null===a?!1:0<=["boolean","number"].indexOf(typeof a)?a:a.__bool__ instanceof Function?a.__bool__()?a:!1:a.__len__ instanceof Function?0!==a.__len__()?a:!1:a instanceof Function?a:0!==x(a)?a:!1}function g(a){this.iterable=a;this.index=0}function f(a){this.iterable=a;this.index=0}function k(a,b,d){void 0==b&&(b=a,a=0);void 0==d&&(d=1);if(0<d&&a>=b||0>d&&a<=b)return[];for(var c=[];0<d?a<b:a>b;a+=d)c.push(a);return c}function w(a){if(null==a||
...
c,e],f):a.__setslice__(b,c,e,f)};(function(){var a=n("TestSystem",[t],{__module__:"__main__",get __init__(){return h(this,function(a){a.on=!1})},get button_alert(){return h(this,function(a){a=prompt("Do you want to go to the Transcrypt site?","Y");if("Y"==a||"y"==a)location.href="https://www.transcrypt.org/"})},get change_button(){return h(this,function(a){a.on?document.getElementById("bulb").src="pic_bulboff.gif":document.getElementById("bulb").src="pic_bulbon.gif";a.on=!a.on})}}),b=a();c.TestSystem=
a;c.__name__="__main__";c.testSystem=b})();return c}window.change_image=change_image();
