"use strict";
// Transcrypt'ed from Python, 2018-02-05 01:08:08
function change_css_attributes_debug () {
    ...
    __all__.__setslice__ = __setslice__;	(function () {
		...
		var TestSystem = __class__ ('TestSystem', [object], {
			...
			get pressed () {return __get__ (this, function (self) {
				...
				var debugstring = (('self.size ' + str (self.size)) + ' self.mult ') + str (self.mult);
...
window ['change_css_attributes_debug'] = change_css_attributes_debug ();
