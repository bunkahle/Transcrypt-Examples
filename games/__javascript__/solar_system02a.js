"use strict";
// Transcrypt'ed from Python, 2018-02-26 08:36:47
function solar_system02a () {
	...
	(function () {
		...
		var SolarSystem = __class__ ('SolarSystem', [object], {
			...
			get __init__ () {return __get__ (this, function (self) {
				...
				self.paused = false;
				self.py_update = window.setTimeout (self.render, 50);
			});},
			get render () {return __get__ (this, function (self) {
				...
				if (!(self.paused)) {
					...
					window.clearTimeout (self.py_update);
				}
			});},
...
window ['solar_system02a'] = solar_system02a ();
