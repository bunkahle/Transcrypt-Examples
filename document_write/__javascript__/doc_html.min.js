...
$jscomp.polyfill=function(e,g,f,h){if(g){f=$jscomp.global;e=e.split(".");for(h=0;h<e.length-1;h++){var n=e[h];n in f||(f[n]={});f=f[n]}e=e[e.length-1];h=f[e];g=g(h);g!=h&&null!=g&&$jscomp.defineProperty(f,e,{configurable:!0,writable:!0,value:g})}};
$jscomp.polyfill("String.prototype.startsWith",function(e){return e?e:function(e,f){var g=$jscomp.checkStringArgs(this,e,"startsWith");e+="";var n=g.length,q=e.length;f=Math.max(0,Math.min(f|0,g.length));for(var m=0;m<q&&f<n;)if(g[f++]!=e[m++])return!1;return m>=q}},"es6","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};$jscomp.symbolCounter_=0;
...
$jscomp.polyfill("Array.from",function(e){return e?e:function(e,f,h){$jscomp.initSymbolIterator();f=null!=f?f:function(e){return e};var g=[],q=e[Symbol.iterator];if("function"==typeof q)for(e=q.call(e);!(q=e.next()).done;)g.push(f.call(h,q.value));else{q=e.length;for(var m=0;m<q;m++)g.push(f.call(h,e[m]))}return g}},"es6","es3");
$jscomp.iteratorFromArray=function(e,g){$jscomp.initSymbolIterator();e instanceof String&&(e+="");var f=0,h={next:function(){if(f<e.length){var n=f++;return{value:g(n,e[n]),done:!1}}h.next=function(){return{done:!0,value:void 0}};return h.next()}};h[Symbol.iterator]=function(){return h};return h};$jscomp.polyfill("Array.prototype.keys",function(e){return e?e:function(){return $jscomp.iteratorFromArray(this,function(e){return e})}},"es6","es3");
$jscomp.findInternal=function(e,g,f){e instanceof String&&(e=String(e));for(var h=e.length,n=0;n<h;n++){var q=e[n];if(g.call(f,q,n,e))return{i:n,v:q}}return{i:-1,v:void 0}};$jscomp.polyfill("Array.prototype.find",function(e){return e?e:function(e,f){return $jscomp.findInternal(this,e,f).v}},"es6","es3");
function doc_html(){function e(a){return void 0===a||null===a?!1:0<=["boolean","number"].indexOf(typeof a)?a:a.__bool__ instanceof Function?a.__bool__()?a:!1:a.__len__ instanceof Function?0!==a.__len__()?a:!1:a instanceof Function?a:0!==v(a)?a:!1}function g(a){this.iterable=a;this.index=0}function f(a){this.iterable=a;this.index=0}function h(a,b,d){void 0==b&&(b=a,a=0);void 0==d&&(d=1);if(0<d&&a>=b||0>d&&a<=b)return[];for(var c=[];0<d?a<b:a>b;a+=d)c.push(a);return c}function n(a){if(null==a||"object"==
typeof a)return a;var b={},d;for(d in obj)a.hasOwnProperty(d)&&(b[d]=a[d]);return b}function q(a){if(null==a||"object"==typeof a)return a;var b={},d;for(d in obj)a.hasOwnProperty(d)&&(b[d]=q(a[d]));return b}function m(a){return a?[].slice.apply(a):[]}function r(a){a=a?[].slice.apply(a):[];a.__class__=r;return a}function t(a){var b=[];if(a)for(var d=0;d<a.length;d++)b.add(a[d]);b.__class__=t;return b}function M(a,b){if(void 0==a)return new Uint8Array(0);b=H(a);if(b==B)return new Uint8Array(a);if(b==
x){b=new Uint8Array(v(a));for(var d=0;d<v(a);d++)b[d]=a.charCodeAt(d);return b}if(b==m||b==r)return new Uint8Array(a);throw P;}function x(a){if("number"===typeof a)return a.toString();try{return a.__str__()}catch(b){try{return I(a)}catch(d){return String(a)}}}function Q(a){return this.hasOwnProperty(a)}function R(){var a=[],b;for(b in this)C(b)||a.push(b);return a}function S(){var a=[],b;for(b in this)C(b)||a.push([b,this[b]]);return a}function T(a){delete this[a]}function U(){for(var a in this)delete this[a]}
function V(a,b){var d=this[a];void 0==d&&(d=this["py_"+a]);return void 0==d?void 0==b?null:b:d}function W(a,b){var d=this[a];if(void 0!=d)return d;b=void 0==b?null:b;return this[a]=b}function X(a,b){var d=this[a];if(void 0!=d)return delete this[a],d;if(void 0===b)throw N(a,Error());return b}function Y(){var a=Object.keys(this)[0];if(null==a)throw N("popitem(): dictionary is empty",Error());var b=r([a,this[a]]);delete this[a];return b}function Z(a){for(var b in a)this[b]=a[b]}function aa(){var a=[],
...
d[f]};c.__nest__=D;var L=function(a){a.__inited__||(a.__all__.__init__(a.__all__),a.__inited__=!0);return a.__all__};c.__init__=L;var l=function(a,b,d){return a&&(a.hasOwnProperty("__class__")||"string"==typeof a||a instanceof String)?(d&&Object.defineProperty(a,d,{value:function(){var d=[].slice.apply(arguments);return b.apply(null,[a].concat(d))},writable:!0,enumerable:!0,configurable:!0}),function(){var d=[].slice.apply(arguments);return b.apply(null,[a].concat(d))}):b};c.__get__=l;c.__getcm__=
function(a,b,d){return a.hasOwnProperty("__class__")?function(){var d=[].slice.apply(arguments);return b.apply(null,[a.__class__].concat(d))}:function(){var d=[].slice.apply(arguments);return b.apply(null,[a].concat(d))}};c.__getsm__=function(a,b,d){return b};var A={__name__:"type",__bases__:[],__new__:function(a,b,d,c){for(var e,w=function(){var a=[].slice.apply(arguments);return w.__new__(a)},f=d.length-1;0<=f;f--){var g=d[f],h;for(h in g)e=Object.getOwnPropertyDescriptor(g,h),Object.defineProperty(w,
h,e)}w.__metaclass__=a;w.__name__=b.startsWith("py_")?b.slice(3):b;w.__bases__=d;for(h in c)e=Object.getOwnPropertyDescriptor(c,h),Object.defineProperty(w,h,e);return w}};A.__metaclass__=A;c.py_metatype=A;var u={__init__:function(a){},__metaclass__:A,__name__:"object",__bases__:[],__new__:function(a){var b=Object.create(this,{__class__:{value:this,enumerable:!0}});this.__init__.apply(null,[b].concat(a));return b}};c.object=u;var p=function(a,b,d,c){void 0===c&&(c=b[0].__metaclass__);return c.__new__(c,
a,b,d)};c.__class__=p;c.__pragma__=function(){};D(c,"org.transcrypt.__base__",{__all__:{__inited__:!1,__init__:function(a){var b=p("__Envir__",[u],{__module__:"org.transcrypt.__base__",get __init__(){return l(this,function(a){a.interpreter_name="python";a.transpiler_name="transcrypt";a.transpiler_version="3.6.94";a.target_subdir="__javascript__"})}}),d=b();a.__Envir__=b;a.__envir__=d;a.__name__="org.transcrypt.__base__"}}});D(c,"org.transcrypt.__standard__",{__all__:{__inited__:!1,__init__:function(a){var b=
p("Exception",[u],{__module__:"org.transcrypt.__standard__",get __init__(){return l(this,function(a){var b=z();if(arguments.length){var d=arguments.length-1;if(arguments[d]&&arguments[d].hasOwnProperty("__kwargtrans__")){var c=arguments[d--],e;for(e in c)switch(e){case "self":a=c[e];break;default:b[e]=c[e]}delete b.__kwargtrans__}d=r([].slice.apply(arguments).slice(1,d+1))}else d=r();a.__args__=d;try{a.stack=b.error.stack}catch(na){a.stack="No stack trace available"}})},get __repr__(){return l(this,
function(a){return v(a.__args__)?"{}{}".format(a.__class__.__name__,I(r(a.__args__))):"{}()".format(a.__class__.__name__)})},get __str__(){return l(this,function(a){return 1<v(a.__args__)?x(r(a.__args__)):v(a.__args__)?x(a.__args__[0]):""})}}),d=p("IterableError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return l(this,function(a,d){b.__init__(a,"Can't iterate over non-iterable",y({error:d}))})}}),c=p("StopIteration",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return l(this,
function(a,d){b.__init__(a,"Iterator exhausted",y({error:d}))})}}),e=p("ValueError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return l(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),f=p("KeyError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return l(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),g=p("AssertionError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return l(this,function(a,d,c){d?b.__init__(a,d,y({error:c})):b.__init__(a,
y({error:c}))})}}),h=p("NotImplementedError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return l(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),k=p("IndexError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return l(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),m=p("AttributeError",[b],{__module__:"org.transcrypt.__standard__",get __init__(){return l(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),q=p("py_TypeError",[b],{__module__:"org.transcrypt.__standard__",
get __init__(){return l(this,function(a,d,c){b.__init__(a,d,y({error:c}))})}}),t=p("Warning",[b],{__module__:"org.transcrypt.__standard__"}),A=p("UserWarning",[t],{__module__:"org.transcrypt.__standard__"}),B=p("DeprecationWarning",[t],{__module__:"org.transcrypt.__standard__"}),C=p("RuntimeWarning",[t],{__module__:"org.transcrypt.__standard__"}),D=function(a,b,d){if("undefined"==typeof b||null!=b&&b.hasOwnProperty("__kwargtrans__"))b=null;if("undefined"==typeof d||null!=d&&d.hasOwnProperty("__kwargtrans__"))d=
...
[u],{__module__:"org.transcrypt.__standard__",get __init__(){return l(this,function(a){a.buffer="";try{a.element=document.getElementById("__terminal__")}catch(ma){a.element=null}a.element&&(a.element.style.overflowX="auto",a.element.style.boxSizing="border-box",a.element.style.padding="5px",a.element.innerHTML="_")})},get print(){return l(this,function(a){var b=" ";var d="\n";if(arguments.length){var c=arguments.length-1;if(arguments[c]&&arguments[c].hasOwnProperty("__kwargtrans__")){var e=arguments[c--],
w;for(w in e)switch(w){case "self":a=e[w];break;case "sep":b=e[w];break;case "end":d=e[w]}}var f=r([].slice.apply(arguments).slice(1,c+1))}else f=r();a.buffer="{}{}{}".format(a.buffer,b.join(function(){for(var a=[],b=f,d=0;d<v(b);d++)a.append(x(b[d]));return a}()),d).__getslice__(-4096,null,1);a.element?(a.element.innerHTML=a.buffer.py_replace("\n","<br>").py_replace(" ","&nbsp"),a.element.scrollTop=a.element.scrollHeight):console.log(b.join(function(){for(var a=[],b=f,d=0;d<v(b);d++)a.append(x(b[d]));
return a}()))})},get input(){return l(this,function(a,b){if(arguments.length){var d=arguments.length-1;if(arguments[d]&&arguments[d].hasOwnProperty("__kwargtrans__")){d=arguments[d--];for(var c in d)switch(c){case "self":a=d[c];break;case "question":b=d[c]}}}a.print("{}".format(b),y({end:""}));c=window.prompt("\n".join(a.buffer.py_split("\n").__getslice__(-16,null,1)));a.print(c);return c})}}),G=E();a.AssertionError=g;a.AttributeError=m;a.DeprecationWarning=B;a.Exception=b;a.IndexError=k;a.IterableError=
d;a.KeyError=f;a.NotImplementedError=h;a.RuntimeWarning=C;a.StopIteration=c;a.py_TypeError=q;a.UserWarning=A;a.ValueError=e;a.Warning=t;a.__Terminal__=E;a.__name__="org.transcrypt.__standard__";a.__sort__=D;a.__terminal__=G;a.filter=function(a,b){null==a&&(a=F);for(var d=[],c=0;c<v(b);c++){var e=b[c];a(e)&&d.append(e)}return d};a.map=function(a,b){for(var d=[],c=0;c<v(b);c++)d.append(a(b[c]));return d};a.sorted=function(a,b,d){if("undefined"==typeof b||null!=b&&b.hasOwnProperty("__kwargtrans__"))b=
null;if("undefined"==typeof d||null!=d&&d.hasOwnProperty("__kwargtrans__"))d=!1;if(arguments.length){var c=arguments.length-1;if(arguments[c]&&arguments[c].hasOwnProperty("__kwargtrans__"))for(e in c=arguments[c--],c)switch(e){case "iterable":a=c[e];break;case "key":b=c[e];break;case "reverse":d=c[e]}}var e=H(a)==z?n(a.py_keys()):n(a);D(e,b,d);return e}}}});c.__call__=function(){var a=[].slice.apply(arguments);return"object"==typeof a[0]&&"__call__"in a[0]?a[0].__call__.apply(a[1],a.slice(2)):a[0].apply(a[1],
...
a.endswith("__")||"constructor"==a||a.startswith("py_")};c.__specialattrib__=C;var v=function(a){if(void 0===a||null===a)return 0;if(a.__len__ instanceof Function)return a.__len__();if(void 0!==a.length)return a.length;var b=0,d;for(d in a)C(d)||b++;return b};c.len=v;c.__t__=e;var E=function(a){if("inf"==a)return Infinity;if("-inf"==a)return-Infinity;if("nan"==a)return NaN;if(isNaN(parseFloat(a))){if(!1===a)return 0;if(!0===a)return 1;throw J("could not convert string to float: '"+x(a)+"'",Error());
}return+a};E.__name__="float";E.__bases__=[u];c.float=E;var B=function(a){return E(a)|0};B.__name__="int";B.__bases__=[u];c.int=B;var F=function(a){return!!e(a)};F.__name__="bool";F.__bases__=[B];c.bool=F;var H=function(a){var b=typeof a;if("object"==b)try{return"__class__"in a?a.__class__:u}catch(d){return b}else return"boolean"==b?F:"string"==b?x:"number"==b?0==a%1?B:E:null};c.py_typeof=H;var G=function(a,b){if(b instanceof Array){for(var d=0;d<b.length;d++){var c=b[d];if(G(a,c))return!0}return!1}try{c=
...
[this].concat([].slice.apply(arguments)))};Array.prototype.__add__=function(a){return m(this.concat(a))};Array.prototype.__mul__=function(a){for(var b=this,d=1;d<a;d++)b=b.concat(this);return b};Array.prototype.__rmul__=Array.prototype.__mul__;c.tuple=r;r.__name__="tuple";r.__bases__=[u];c.set=t;t.__name__="set";t.__bases__=[u];Array.prototype.__bindexOf__=function(a){a+="";for(var b=0,d=this.length-1;b<=d;){var c=(b+d)/2|0,e=this[c]+"";if(e<a)b=c+1;else if(e>a)d=c-1;else return c}return-1};Array.prototype.add=
...
t(this.slice().sort()),d=0;d<a.length;d++)-1==b.__bindexOf__(a[d])&&b.push(a[d]);return b};Array.prototype.intersection=function(a){this.sort();for(var b=t(),d=0;d<a.length;d++)-1!=this.__bindexOf__(a[d])&&b.push(a[d]);return b};Array.prototype.difference=function(a){a=t(a.slice().sort());for(var b=t(),d=0;d<this.length;d++)-1==a.__bindexOf__(this[d])&&b.push(this[d]);return b};Array.prototype.symmetric_difference=function(a){return this.union(a).difference(this.intersection(a))};Array.prototype.py_update=
...
get change_doc(){return l(this,function(a){var b=document.getElementById("textareaCode").value;b=b.py_replace("</textarea>","&lt;/textarea&gt;");window.location="about:blank";document.write(a.header);document.write(b);a=a.footer.__getslice__(0,null,1);b=b.py_replace("&lt;","<").py_replace("&gt;",">");var c=a.lower().find('<div id="playground">')+v('<div id="playground">'),d=a.lower().find("</div>");document.write(a.__getslice__(0,c,1)+b+a.__getslice__(d,null,1));document.close()})}}),b=a();c.TestSystem=
a;c.__name__="__main__";c.testSystem=b})();return c}window.doc_html=doc_html();
