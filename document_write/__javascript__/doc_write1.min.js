...
function doc_write1(){function e(a){return void 0===a||null===a?!1:0<=["boolean","number"].indexOf(typeof a)?a:a.__bool__ instanceof Function?a.__bool__()?a:!1:a.__len__ instanceof Function?0!==a.__len__()?a:!1:a instanceof Function?a:0!==x(a)?a:!1}function g(a){this.iterable=a;this.index=0}function f(a){this.iterable=a;this.index=0}function k(a,b,d){void 0==b&&(b=a,a=0);void 0==d&&(d=1);if(0<d&&a>=b||0>d&&a<=b)return[];for(var c=[];0<d?a<b:a>b;a+=d)c.push(a);return c}function w(a){if(null==a||"object"==
...
c,e],f):a.__setslice__(b,c,e,f)};(function(){var a=n("TestSystem",[t],{__module__:"__main__",get __init__(){return h(this,function(a){a.header='<!DOCTYPE html>\n<html lang="en">\n  <head>\n    <meta charset="utf-8" />\n    <title>DocWrite</title>\n  </head>\n  <body>\n';a.footer="\n  </body>\n</html>"})},get write(){return h(this,function(a){document.open();document.write(a.header);document.write("Hello World!");document.write("Have a nice day!");document.write("<p>Note that writeln() adds a new line after each statement:</p>");
document.writeln("Hello World!<br>");document.writeln("Have a nice day!<br>");document.writeln("Check the sourcecode for line breaks! (Right mousebutton on the html document and click view sourcecode<br><br>");document.writeln(Date());document.write('    <button onclick="window.history.back();">Go Back</button>');document.write(a.footer);document.close()})}}),b=a();c.TestSystem=a;c.__name__="__main__";c.testSystem=b})();return c}window.doc_write1=doc_write1();
