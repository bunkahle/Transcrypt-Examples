...
function read_file4(){function e(a){return void 0===a||null===a?!1:0<=["boolean","number"].indexOf(typeof a)?a:a.__bool__ instanceof Function?a.__bool__()?a:!1:a.__len__ instanceof Function?0!==a.__len__()?a:!1:a instanceof Function?a:0!==x(a)?a:!1}function g(a){this.iterable=a;this.index=0}function f(a){this.iterable=a;this.index=0}function k(a,b,d){void 0==b&&(b=a,a=0);void 0==d&&(d=1);if(0<d&&a>=b||0>d&&a<=b)return[];for(var c=[];0<d?a<b:a>b;a+=d)c.push(a);return c}function w(a){if(null==a||"object"==
...
c,e],f):a.__setslice__(b,c,e,f)};(function(){var a=n("TestSystem",[t],{__module__:"__main__",get openFile(){return h(this,function(a,b){a.inputvar=b.target;a.freader=new FileReader;a.freader.onload=a.processInput;a.freader.readAsDataURL(a.inputvar.files[0])})},get processInput(){return h(this,function(a){a=a.freader.result;document.getElementById("output").src=a})}}),b=a();c.TestSystem=a;c.__name__="__main__";c.testSystem=b})();return c}window.read_file4=read_file4();
