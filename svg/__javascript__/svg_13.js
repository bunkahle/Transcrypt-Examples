"use strict";
// Transcrypt'ed from Python, 2022-05-11 08:10:22
function svg_13 () {
	...
	(function () {
		var SVG = __class__ ('SVG', [object], {
			get __init__ () {return __get__ (this, function (self) {
				...
				self.p1.setAttribute ('fill', '#0000ff');
				...
				self.p2.setAttribute ('fill', '#ffff00');
				...
				self.t1 = self.draw_graphic ('text', 'x:45; y:100; font-size:20; family-font:Verdana; text-anchor:middle; fill:black');
